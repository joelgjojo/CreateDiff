...
class AppTheme {
  ...
  // ==========================================
  // DARK THEME (#080A0F Deep Charcoal Studio)
  // ==========================================
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      colorScheme: const ColorScheme.dark(
        ...
        onPrimaryContainer: CDColors.accentBright,
      ...
      textTheme: _buildTextTheme(baseTextTheme, CDColors.darkTextPrimary, CDColors.darkTextSecondary),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: const TextStyle(color: CDColors.darkTextPrimary, fontSize: 13, fontWeight: FontWeight.w500),
  ...
  // ==========================================
  // LIGHT THEME (#F1F4F8 Frosted Daylight)
  // ==========================================
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        primary: CDColors.lightAccent,
        onPrimary: Colors.white,
        primaryContainer: CDColors.lightAccentSubtle,
        onPrimaryContainer: CDColors.lightAccent,
      ...
      textTheme: _buildTextTheme(baseTextTheme, CDColors.lightTextPrimary, CDColors.lightTextSecondary),
      appBarTheme: const AppBarTheme(
        backgroundColor: Colors.transparent,
        elevation: 0,
        centerTitle: false,
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: const TextStyle(color: CDColors.lightTextPrimary, fontSize: 13, fontWeight: FontWeight.w500),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(CDRadius.medium)),
        behavior: SnackBarBehavior.floating,
      ),
    );
